...
import { assert, normalizeKeys, formCompoundKey } from './utils';
    ...
    return function (target, methodName, descriptor) {
        ...
        descriptor.value = function AutoSubscribe() {
            ...
            var specificKeyValues = (autoSubscribeKeys && autoSubscribeKeys.length > 0) ?
                _.map(autoSubscribeKeys, function (autoSubKey) { return formCompoundKey.apply(void 0, keyParamValues.concat(autoSubKey)); }) :
                [(keyParamValues.length > 0) ? formCompoundKey.apply(void 0, keyParamValues) : StoreBase.Key_All];
...
export var autoSubscribe = makeAutoSubscribeDecorator(true, undefined);
