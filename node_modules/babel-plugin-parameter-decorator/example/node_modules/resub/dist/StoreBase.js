...
var StoreBase = /** @class */ (function () {
    ...
    StoreBase.prototype.trigger = function (keyOrKeys) {
        ...
        if (!keyOrKeys && !_.isNumber(keyOrKeys)) {
            ...
            _.forEach(allSubs, function (sub) {
            ...
            var keys_1 = utils_1.normalizeKeys(keyOrKeys);
    ...
    StoreBase.prototype._setupSpecificKeySubscription = function (keys, callback, throttledUntil, bypassBlock) {
        ...
        if (existingMeta === undefined) {
            ...
            StoreBase._pendingCallbacks.set(callback, { keys: keys.slice(), throttledUntil: throttledUntil, bypassBlock: bypassBlock });
        }
    ...
    StoreBase.prototype.subscribe = function (callback, rawKey) {
        ...
        utils_1.assert(key && _.isString(key), "Trying to subscribe to invalid key: \"" + key + "\"");
    ...
    StoreBase.prototype.unsubscribe = function (subToken) {
        utils_1.assert(this._subsByNum[subToken], "No subscriptions found for token " + subToken);
