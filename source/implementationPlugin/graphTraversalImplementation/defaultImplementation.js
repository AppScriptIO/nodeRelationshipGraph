...
import { allPromise, chronological, raceFirstPromise, iteratePort } from './concreteFunction/handlePropagation.js'
import { portConnection } from './concreteFunction/traverseNode.js'
import { processThenTraverse, conditionCheck } from './concreteFunction/traversalInterception.js'

export const implementation = {
  traverseNode: { portConnection },
  handlePropagation: { allPromise, chronological, raceFirstPromise },
